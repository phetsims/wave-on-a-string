...
define( function( require ) {
  ...
  function PulseButton( model, options ) {
    ...
    this.addChild( new PushButton(
      new Node( {children: [new Image( imageLoader.getImage( 'button_pulse_unpressed.png' ) ), label]} ),
      new Node( {children: [new Image( imageLoader.getImage( 'button_pulse_hover.png' ) ), label]} ),
      new Node( {children: [new Image( imageLoader.getImage( 'button_pulse_pressed.png' ) ), label]} ),
      new Node( {children: [new Image( imageLoader.getImage( 'button_pulse_unpressed.png' ) ), label]} ),
      restart, {scale: 0.7} ) );
