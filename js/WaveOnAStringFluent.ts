...
const WaveOnAStringFluent = {
  ...
  a11y: {
    screenSummary: {
      ...
      currentDetails: {
        start: new FluentPattern<{ active: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, amplitude: number | 'zero' | 'low' | 'medium' | 'high' | TReadOnlyProperty<number | 'zero' | 'low' | 'medium' | 'high'>, frequency: number | 'zero' | 'low' | 'medium' | 'high' | TReadOnlyProperty<number | 'zero' | 'low' | 'medium' | 'high'>, isFlat: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, isPlaying: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'>, mode: 'manual' | number | 'other' | 'oscillate' | 'pulse' | TReadOnlyProperty<'manual' | number | 'other' | 'oscillate' | 'pulse'>, wrenchPosition: 'bottom' | 'middle' | 'top' | TReadOnlyProperty<'bottom' | 'middle' | 'top'> }>( fluentSupport.bundleProperty, 'a11y_screenSummary_currentDetails_start', _.get( WaveOnAStringStrings, 'a11y.screenSummary.currentDetails.startStringProperty' ), [{"name":"active","variants":["true","false"]},{"name":"amplitude","variants":[{"type":"number","value":"zero"},"low","medium","high"]},{"name":"frequency","variants":[{"type":"number","value":"zero"},"low","medium","high"]},{"name":"isFlat","variants":["true","false"]},{"name":"isPlaying","variants":["false","true"]},{"name":"mode","variants":["manual",{"type":"number","value":"other"},"oscillate","pulse"]},{"name":"wrenchPosition","variants":["bottom","middle","top"]}] ),
