...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "EnumerationIO(FIXED_END|LOOSE_END|NO_END)": {
      "documentation": "Possible values: FIXED_END,LOOSE_END,NO_END.",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "EnumerationIO(FIXED_END|LOOSE_END|NO_END)"
    },
    "EnumerationIO(MANUAL|OSCILLATE|PULSE)": {
      "documentation": "Possible values: MANUAL,OSCILLATE,PULSE.",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "EnumerationIO(MANUAL|OSCILLATE|PULSE)"
    },
    "EventIO": {
    ...
    "FunctionIO(EnumerationIO(FIXED_END|LOOSE_END|NO_END),NullableIO<EnumerationIO(FIXED_END|LOOSE_END|NO_END)>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> EnumerationIO(FIXED_END|LOOSE_END|NO_END), NullableIO<EnumerationIO(FIXED_END|LOOSE_END|NO_END)><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "EnumerationIO(FIXED_END|LOOSE_END|NO_END)",
        "NullableIO<EnumerationIO(FIXED_END|LOOSE_END|NO_END)>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(EnumerationIO(FIXED_END|LOOSE_END|NO_END),NullableIO<EnumerationIO(FIXED_END|LOOSE_END|NO_END)>)=>VoidIO"
    },
    "FunctionIO(EnumerationIO(MANUAL|OSCILLATE|PULSE),NullableIO<EnumerationIO(MANUAL|OSCILLATE|PULSE)>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> EnumerationIO(MANUAL|OSCILLATE|PULSE), NullableIO<EnumerationIO(MANUAL|OSCILLATE|PULSE)><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "EnumerationIO(MANUAL|OSCILLATE|PULSE)",
        "NullableIO<EnumerationIO(MANUAL|OSCILLATE|PULSE)>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(EnumerationIO(MANUAL|OSCILLATE|PULSE),NullableIO<EnumerationIO(MANUAL|OSCILLATE|PULSE)>)=>VoidIO"
    },
    ...
    "NullableIO<EnumerationIO(FIXED_END|LOOSE_END|NO_END)>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<EnumerationIO(FIXED_END|LOOSE_END|NO_END)>"
    },
    "NullableIO<EnumerationIO(MANUAL|OSCILLATE|PULSE)>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<EnumerationIO(MANUAL|OSCILLATE|PULSE)>"
    },
    "NullableIO<FocusIO>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "PropertyIO<EnumerationIO(FIXED_END|LOOSE_END|NO_END)>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(FIXED_END|LOOSE_END|NO_END)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<EnumerationIO(FIXED_END|LOOSE_END|NO_END)>"
    },
    "PropertyIO<EnumerationIO(MANUAL|OSCILLATE|PULSE)>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(MANUAL|OSCILLATE|PULSE)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<EnumerationIO(MANUAL|OSCILLATE|PULSE)>"
    },
