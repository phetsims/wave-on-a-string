...
const WaveOnAStringFluent = {
  "wave-on-a-string": {
    ...
    titleStringProperty: _.get( WaveOnAStringStrings, 'wave-on-a-string.titleStringProperty' )
  },
  rulersStringProperty: _.get( WaveOnAStringStrings, 'rulersStringProperty' ),
  timerStringProperty: _.get( WaveOnAStringStrings, 'timerStringProperty' ),
  amplitudeStringProperty: _.get( WaveOnAStringStrings, 'amplitudeStringProperty' ),
  frequencyStringProperty: _.get( WaveOnAStringStrings, 'frequencyStringProperty' ),
  pulseWidthStringProperty: _.get( WaveOnAStringStrings, 'pulseWidthStringProperty' ),
  dampingStringProperty: _.get( WaveOnAStringStrings, 'dampingStringProperty' ),
  tensionStringProperty: _.get( WaveOnAStringStrings, 'tensionStringProperty' ),
  lowStringProperty: _.get( WaveOnAStringStrings, 'lowStringProperty' ),
  highStringProperty: _.get( WaveOnAStringStrings, 'highStringProperty' ),
  manualStringProperty: _.get( WaveOnAStringStrings, 'manualStringProperty' ),
  oscillateStringProperty: _.get( WaveOnAStringStrings, 'oscillateStringProperty' ),
  pulseStringProperty: _.get( WaveOnAStringStrings, 'pulseStringProperty' ),
  restartStringProperty: _.get( WaveOnAStringStrings, 'restartStringProperty' ),
  fixedEndStringProperty: _.get( WaveOnAStringStrings, 'fixedEndStringProperty' ),
  looseEndStringProperty: _.get( WaveOnAStringStrings, 'looseEndStringProperty' ),
  noEndStringProperty: _.get( WaveOnAStringStrings, 'noEndStringProperty' ),
  speedNormalStringProperty: _.get( WaveOnAStringStrings, 'speedNormalStringProperty' ),
  speedSlowStringProperty: _.get( WaveOnAStringStrings, 'speedSlowStringProperty' ),
  referenceLineStringProperty: _.get( WaveOnAStringStrings, 'referenceLineStringProperty' ),
  unitCmStringProperty: _.get( WaveOnAStringStrings, 'unitCmStringProperty' ),
  ...
  keyboardHelpDialog: {
    stringControlsStringProperty: _.get( WaveOnAStringStrings, 'keyboardHelpDialog.stringControlsStringProperty' )
  },
  a11y: {
    screenSummary: {
