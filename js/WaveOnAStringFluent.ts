...
const WaveOnAStringFluent = {
  ...
  a11y: {
    screenSummary: {
      ...
      currentDetails: {
        start: new FluentPattern<{ active: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, amplitude: number | 'zero' | 'low' | 'medium' | 'high' | TReadOnlyProperty<number | 'zero' | 'low' | 'medium' | 'high'>, frequency: number | 'zero' | 'low' | 'medium' | 'high' | TReadOnlyProperty<number | 'zero' | 'low' | 'medium' | 'high'>, isPlaying: 'false' | 'true' | TReadOnlyProperty<'false' | 'true'>, isStill: 'true' | 'false' | TReadOnlyProperty<'true' | 'false'>, mode: 'manual' | number | 'other' | 'oscillate' | 'pulse' | TReadOnlyProperty<'manual' | number | 'other' | 'oscillate' | 'pulse'>, pulseWidth: 'low' | 'medium' | 'high' | TReadOnlyProperty<'low' | 'medium' | 'high'>, wrenchPosition: 'bottom' | 'middle' | 'top' | TReadOnlyProperty<'bottom' | 'middle' | 'top'> }>( fluentSupport.bundleProperty, 'a11y_screenSummary_currentDetails_start', _.get( WaveOnAStringStrings, 'a11y.screenSummary.currentDetails.startStringProperty' ), [{"name":"active","variants":["true","false"]},{"name":"amplitude","variants":[{"type":"number","value":"zero"},"low","medium","high"]},{"name":"frequency","variants":[{"type":"number","value":"zero"},"low","medium","high"]},{"name":"isPlaying","variants":["false","true"]},{"name":"isStill","variants":["true","false"]},{"name":"mode","variants":["manual",{"type":"number","value":"other"},"oscillate","pulse"]},{"name":"pulseWidth","variants":["low","medium","high"]},{"name":"wrenchPosition","variants":["bottom","middle","top"]}] ),
